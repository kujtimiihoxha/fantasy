...
func TestDefaultToPrompt_MediaToolResult_DeferredFlushAtEnd(t *testing.T) {
	t.Parallel()
...
// own tool message.
func TestDefaultToPrompt_MediaToolResult_MixedBatchKeepsTextInline(t *testing.T) {
	t.Parallel()
...
func TestDefaultToPrompt_MediaToolResult_DeferredBeforeAssistant(t *testing.T) {
	t.Parallel()
