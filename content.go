...
// CompactionPart carries an opaque provider checkpoint for replay.
type CompactionPart struct {
	ProviderOptions ProviderOptions `json:"provider_options,omitempty"`
}

// GetType implements MessagePart.
func (c CompactionPart) GetType() ContentType { return ContentTypeCompaction }

// Options implements MessagePart.
func (c CompactionPart) Options() ProviderOptions { return c.ProviderOptions }
...
const (
	...
	// ContentTypeCompaction represents an opaque provider checkpoint.
...
// CompactionContent carries an opaque provider checkpoint from a response.
...
func (c CompactionContent) GetType() ContentType { return ContentTypeCompaction }
